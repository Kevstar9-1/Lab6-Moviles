              ...
              onPressed: () async {
                if (_formKey2.currentState!.validate()) {
                  ...
                  try {
                    ...
                    // Inicio de sesión exitoso, puedes hacer algo aquí si lo deseas
                    print(
                        'Usuario registrado: ${userCredential.user!.email}');
                    ...
                    setState(() {
                      _mensajeError = 'Error durante el inicio de sesión: $e';
                    });
                    print(_mensajeError);
                  }
                }
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  try {
                    ...
                    // Inicio de sesión exitoso, puedes hacer algo aquí si lo deseas
                    print(
                        'Usuario inició sesión: ${userCredential.user!.email}');
